...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      {purposeData && <PurposeSection data={purposeData} />}
      ...
      {identityData && <IdentitySection data={identityData} />}
      ...
      {anselmData && <AnselmSection anselmSection={anselmData} />}

      {/* Lasting Section - Dynamic from Sanity */}
      {lastingData && <LastingSection data={lastingData} />}
    </main>
  );
}
